    ...
    const ValidateUserName = () => {
        ...
        if (userName.length < 8) {
            ...
            for (let i = 0; i < userName.length; i++) {
                ...
                let valid = (ch >= 0) && (ch <= 9) || (ch >= 'a') && (ch <= 'z') || (ch >= 'A') && (ch <= 'Z')
                    (ch == '@') || (ch == '$') || (ch == '_') || (ch == '#');
                if (valid) {

                } else {
                    console.log("user name length should be of min 8 length \n it must contains combination and numeric and alhabets \n you can also use speacial keyword like @ , # , _ ");
                }//end if else inner
            }//end for
        }//end if else outer
        ...
        if (user.length <= 5) {
            ...
            for (let i = 0; i < user.length; i++) {
                ...
                if (valid) {
                    ...
                    console.log("email user name is not valid it must contains and alpphabets , numberic and special character @ , $ , _");
                }//end if else
            }
